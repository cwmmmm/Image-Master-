...
QT_MOC_LITERAL(1, 14, 21), // "signalCompleteCapture"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 12) // "captureImage"

    },
    "CaptureScreen\0signalCompleteCapture\0"
    "\0captureImage"
};
...
void CaptureScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureScreen::signalCompleteCapture)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureScreen::signalCompleteCapture(QPixmap _t1)
{
